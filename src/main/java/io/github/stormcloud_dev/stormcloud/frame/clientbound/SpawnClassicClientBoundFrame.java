...
public class SpawnClassicClientBoundFrame extends ClientBoundFrame {
    ...
    public SpawnClassicClientBoundFrame(double objectIndex, double multiplayerId, short cardChoice, double x, double y, byte elite, short eliteTier, short pointValue, short imageXScale) {
        super((byte) 15, objectIndex, multiplayerId);
