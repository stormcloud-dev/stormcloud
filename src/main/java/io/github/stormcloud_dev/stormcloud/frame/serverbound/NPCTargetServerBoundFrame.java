...
public class NPCTargetServerBoundFrame extends ServerBoundFrame {
    ...
    public NPCTargetServerBoundFrame(double x, double y, int targetParentMId, short direction, byte forceSpeedUp) {
        super((byte) 10);
        this.x = x;
        this.y = y;
