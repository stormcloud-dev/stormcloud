...
public class SpawnDroneServerBoundFrame extends ServerBoundFrame {
    ...
    public SpawnDroneServerBoundFrame(short x, short y, short oId, short mId, short masterMId, short xx, short yy) {
        super((byte) 31);
        this.x = x;
        this.y = y;
        this.oId = oId;
