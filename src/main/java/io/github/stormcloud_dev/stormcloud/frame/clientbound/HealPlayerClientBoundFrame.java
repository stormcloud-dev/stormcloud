...
public class HealPlayerClientBoundFrame extends ClientBoundFrame {
    ...
    public HealPlayerClientBoundFrame(double objectIndex, double multiplayerId, double unknown1, double unknown2, double unknown3, double unknown4) {
        super((byte) 7, objectIndex, multiplayerId);
