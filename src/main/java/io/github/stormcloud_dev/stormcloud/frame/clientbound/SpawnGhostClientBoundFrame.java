...
public class SpawnGhostClientBoundFrame extends ClientBoundFrame {
    ...
    public SpawnGhostClientBoundFrame(double objectIndex, double multiplayerId, short x, short y, float damageCoefficient, float healthCoefficient) {
        super((byte) 40, objectIndex, multiplayerId);
        this.x = x;
        this.y = y;
