...
public class LandLizardClientBoundFrame extends ClientBoundFrame {

    private short targetX;
    private short targetY;

    public LandLizardClientBoundFrame(double objectIndex, double multiplayerId, short targetX, short targetY) {
        super((byte) 42, objectIndex, multiplayerId);
