...
public class SyncAlarmClientBoundFrame extends ClientBoundFrame {
    ...
    public SyncAlarmClientBoundFrame(double objectIndex, double multiplayerId, double unknown1, double unknown2, double unknown3, double unknown4, int unknown5) {
        super((byte) 14, objectIndex, multiplayerId);
