...
public class CreateSlimeClientBoundFrame extends ClientBoundFrame {
    ...
    public CreateSlimeClientBoundFrame(double objectIndex, double multiplayerId, short x, short y, float size, short maxHP, short damage, short expWorth, byte elite, short eliteTier2, double imageBlend) {
        super((byte) 44, objectIndex, multiplayerId);
        this.x = x;
        this.y = y;
        this.size = size;
        this.maxHP = maxHP;
