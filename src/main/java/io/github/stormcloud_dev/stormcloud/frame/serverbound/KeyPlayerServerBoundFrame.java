...
public class KeyPlayerServerBoundFrame extends ServerBoundFrame {
    ...
    public KeyPlayerServerBoundFrame(short x, short y, byte zAction, byte xAction, byte cAction, byte vAction, short itemUsed, byte unknown) {
        super((byte) 6);
        this.x = x;
        this.y = y;
