...
public class PositionInfoServerBoundFrame extends ServerBoundFrame {
    ...
    public PositionInfoServerBoundFrame(double x, double y, byte left, byte right, byte jump, byte jumpHeld, byte up, byte down) {
        super((byte) 0);
        this.x = x;
        this.y = y;
        this.left = left;
