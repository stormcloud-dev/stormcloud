...
public class CreateLevelObjectClientBoundFrame extends ClientBoundFrame {
    ...
    public CreateLevelObjectClientBoundFrame(double objectIndex, double multiplayerId, double unknown1, double unknown2, double unknown3, double unknown4, int unknown5) {
        super((byte) 13, objectIndex, multiplayerId);
