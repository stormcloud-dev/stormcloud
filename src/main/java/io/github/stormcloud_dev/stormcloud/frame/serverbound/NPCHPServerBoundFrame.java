...
public class NPCHPServerBoundFrame extends ServerBoundFrame {
    ...
    public NPCHPServerBoundFrame(double hp, double x, double y, short xScale, short knockback, short ticksTillChase) {
        super((byte) 8);
        this.hp = hp;
        this.x = x;
        this.y = y;
