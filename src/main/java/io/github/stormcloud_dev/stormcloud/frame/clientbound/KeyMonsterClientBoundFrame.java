...
public class KeyMonsterClientBoundFrame extends ClientBoundFrame {
    ...
    public KeyMonsterClientBoundFrame(double objectIndex, double multiplayerId, double x, double y, byte zAction, byte xAction, byte cAction, byte vAction, short imageXScale) {
        super((byte) 11, objectIndex, multiplayerId);
        this.x = x;
        this.y = y;
