...
public class SpawnClassicBossClientBoundFrame extends ClientBoundFrame {
    ...
    public SpawnClassicBossClientBoundFrame(double objectIndex, double multiplayerId, double x, double y, int sprite, int childIndex, double soundSpawn, byte elite, short eliteTier, short pointValue, short imageXScale, double imageBlend) {
        super((byte) 23, objectIndex, multiplayerId);
        this.x = x;
        this.y = y;
        this.sprite = sprite;
