...
public class ActivateObjectServerBoundFrame extends ServerBoundFrame {

    private double playerX;
    private double playerY;
    private short objectActivated;
    private short objectMId;
    private byte intendedActiveState;

    public ActivateObjectServerBoundFrame(double playerX, double playerY, short objectActivated, short objectMId, byte intendedActiveState, byte success) {
        super((byte) 19);
        this.playerX = playerX;
        this.playerY = playerY;
        this.objectActivated = objectActivated;
        this.objectMId = objectMId;
        this.intendedActiveState = intendedActiveState;
    }
    ...
    public byte getIntendedActiveState() {
        return intendedActiveState;
    }
    ...
    public void writeData(ByteBuf buf, ChannelHandlerContext ctx) {
        ...
        buf.writeByte(getIntendedActiveState());
    }
