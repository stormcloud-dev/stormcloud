...
public class UpdateDiffClientBoundFrame extends ClientBoundFrame {
    ...
    public UpdateDiffClientBoundFrame(double objectIndex, double multiplayerId, byte diffLevel, byte forceItemSharing, byte honorActive, byte kinActive, byte distortionActive, byte spiteActive, byte glassActive, byte enigmaActive, byte sacrificeActive, byte commandActive, byte spiritActive, byte originActive) {
        super((byte) 39, objectIndex, multiplayerId);
