...
public class CreateLevelObjectServerBoundFrame extends ServerBoundFrame {
    ...
    public CreateLevelObjectServerBoundFrame(double unknown1, double unknown2, double unknown3, double unknown4, int unknown5) {
        super((byte) 13);
