...
public class UpdateBuffsClientBoundFrame extends ClientBoundFrame {
    ...
    public UpdateBuffsClientBoundFrame(double objectIndex, double multiplayerId, double unknown1, short unknown2, short unknown3) {
        super((byte) 34, objectIndex, multiplayerId);
