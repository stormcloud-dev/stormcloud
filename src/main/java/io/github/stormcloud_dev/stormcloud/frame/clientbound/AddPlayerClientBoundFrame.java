...
public class AddPlayerClientBoundFrame extends ClientBoundFrame {
    ...
    public AddPlayerClientBoundFrame(double objectIndex, double multiplayerId, double x, double y, double mId, int clazz, int hostPlayer, String name) {
        super((byte) 3, objectIndex, multiplayerId);
        this.x = x;
        this.y = y;
        this.mId = mId;
        this.clazz = clazz;
    ...
    public AddPlayerClientBoundFrame(double objectIndex, double multiplayerId, double x, double y, double mId, CrewMember clazz, int hostPlayer, String name) {
        super((byte) 3, objectIndex, multiplayerId);
        this.x = x;
        this.y = y;
        this.mId = mId;
