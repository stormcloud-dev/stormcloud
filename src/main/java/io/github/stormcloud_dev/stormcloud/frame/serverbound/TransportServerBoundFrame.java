...
public class TransportServerBoundFrame extends ServerBoundFrame {
    ...
    public TransportServerBoundFrame(double unknown1, double unknown2, double unknown3, double unknown4, double unknown5, byte unknown6) {
        super((byte) 18);
